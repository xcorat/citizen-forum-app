...
const googleFormAddrDebug = "1FAIpQLSeqF9ul6PUYIYNidtXCxdqwT4C0ck8z_prGkhqGzFXJYXGg9A" //import.meta.env.VITE_GOOGLE_FORM_ADDR_DEBUG as string;
...
exports.handler = async function(form_summary) {
